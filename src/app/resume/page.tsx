        ...
        <div className="max-w-4xl mx-auto p-6 font-serif">
            ...
            <div className="text-center mb-6">
                ...
                <p className="text-sm">
                    ...
                    <a href={data.basics.website} className="text-blue-600 hover:underline ml-1">
            ...
            <div className="mb-6">
                ...
                {data.skills.map((skillGroup, index) => (
                    skillGroup.keywords && skillGroup.keywords.filter(k => k).length > 0 && (
            ...
            <div>
                ...
                {data.projects.some(p => p.url) && (
                    <div className="text-sm italic text-right">
                        <a href={data.projects.find(p => p.url)?.url} className="text-blue-600 hover:underline">
